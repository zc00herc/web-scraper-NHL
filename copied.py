# requests package fetches info from a passed website
import requests
# beautifulsoup reads either html or xml
from bs4 import BeautifulSoup
# for working with CSV. probably to be switched out to something more useful like Pandas
import csv

# this is the iterative scraper from the orig source. It iterates through quotes in the quote scrape
# website. This is very specific to that page. and need something specific to my use case
